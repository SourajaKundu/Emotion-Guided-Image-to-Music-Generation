...
def create_model_with_2_enc_2_dec_transformer(vocab_size, max_length, feature_extractor_label="VG16"):
    # Image feature extractor model
    if feature_extractor_label == "VG16":
        inputs1 = Input(shape=(4096,))
    elif feature_extractor_label == "InceptionV3":
...
def create_model_with_2_enc_transformer(vocab_size, max_length, feature_extractor_label="InceptionV3"):
    # Image feature extractor model
    if feature_extractor_label == "VG16":
        inputs1 = Input(shape=(4096,))
    elif feature_extractor_label == "InceptionV3":
...
def create_model_with_4_enc_transformer_MIDI(vocab_size, max_length, feature_extractor_label="VG16"):
    # Image feature extractor model
    if feature_extractor_label == "VG16":
        inputs1 = Input(shape=(4096,))
    elif feature_extractor_label == "InceptionV3":
...
def create_midi(prediction_output, midiName):
  ...
  midi_stream.write('midi', fp='testMidi_trans_3/' + midiName + '.mid')
...
filepath = 'training_new_model/trans3encdec.weights.h5'
