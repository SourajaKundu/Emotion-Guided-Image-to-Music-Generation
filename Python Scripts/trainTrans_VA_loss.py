...
tokenizer = load_featuresPickle('tokenizer.pkl')
...
def create_midi(prediction_output, midiName):
  ...
  midi_stream.write('midi', fp= 'testMidi_trans3_VA_loss/' + midiName + '.mid')
...
filepath = 'training_new_model/trans_3_enc_dec_VA_loss.weights.h5'
